...
void first()
{
	...
	glColor3f(0.75, 0.75, 0.75);
	strokeString(200, 500, 0.3, 0.3, "OPENGL PACKAGE ON", 2);
	glColor3f(0, 0.5, 0.5);
	...
	strokeString(650, 60, 0.15, 0.15, "Original Author", 2);
	glColor3f(0.74,0.72,0.42);
	strokeString(650, 160, 0.18, 0.18, "Yiliu Dong", 2);
	strokeString(650, 30, 0.2, 0.2, "Girish Kumar.N", 2);
	strokeString(650, 120, 0.18, 0.18, "2021210868", 2);
	glutSwapBuffers();
}		
